<template>
  <b-card-group class="mx-auto" ref="info">
    <b-card-header
      class="w-100"
      @mousedown="alert('hihihi')"
      style="background-color: limegreen"
    >Informacje o projekcie</b-card-header>
    <b-card>
      ...
      <b-card-body class="w-100" v-else>
        <b-card-title class="mb-0 border-bottom align-middle">
          <b-row>
            ...
            <b-col class="text-right">
              ...
              <b-button class="ml-5 mb-2" @click="isEdited = !isEdited">Edytuj</b-button>
            </b-col>
          </b-row>
        </b-card-title>
        ...
        <b-card-text>
          ...
          <label v-if="info.accountNumber">Informacje o płatności:</label>
          <h5 style="white-spaces: pre">{{info.accountNumber}}</h5>
        </b-card-text>
      </b-card-body>
    </b-card>
  </b-card-group>
