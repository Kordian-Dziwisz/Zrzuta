    ...
    <table class="table table-light table-striped bordercontainer">
      <thead>
        <tr>
          <th>
            <b-row class="ml-4">
              <b-col class="pl-0 col-lg-2 align-self-center overflow-hidden text-center">Twórca</b-col>
              <b-col class="pl-2 col-lg-2 align-self-center overflow-hidden text-center">Nazwa</b-col>
